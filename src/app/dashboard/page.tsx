...
export default async function DashboardIndex() {
  ...
  return (
    <div className="min-h-dvh bg-slate-50 px-6 py-12 text-slate-900">
      <div className="mx-auto max-w-2xl">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-semibold">Your companies</h1>
            <p className="mt-1 text-sm text-slate-500">Pick a workspace or create a new one.</p>
          </div>
        ...
        <div className="mt-6 space-y-2">
          {companies.map((c) => (
            <Link
              ...
              className="flex items-center justify-between rounded-xl border border-slate-200 bg-white px-5 py-4 hover:border-indigo-300"
            >
